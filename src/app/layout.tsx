...
export const metadata: Metadata = {
  ...
  description:
    "Experienced in VB.NET and React.js, with additional exposure to Flutter. Passionate about solving real-world problems and committed to continuous learning and improvement in every project",
  keywords: [
    "MERN Stack",
    "MERN",
    "Mongodb",
