  ...
  certications: [
    {
      ...
      certificate_detail:
        "Completed a 4-month intensive course focused on full-stack web development using the MERN stack (MongoDB, Express.js, React.js, and Node.js). Gained practical experience in building dynamic web applications, developing RESTful APIs, managing databases, and implementing frontend designs with React",
    },
    {
      institute_name: "Nexus Berry Training & Solution: ",
...
const projects = {
  title: "Building Modern Web & Desktop Application",
  summary:
    "I build modern, high-performance web applications with Next.js 15, Tailwind CSS v4, and the latest technologies, working on key components such as the footer, product display page, and other features to deliver sleek, responsive, and engaging user experiences.",
  card: [
    {
      id: "01",
      title: "My Portfolio",
...
const greeting = {
  ...
  subTitle:
    "I’m a passionate full-stack developer specializing in building robust web applications and cross-platform desktop software. With expertise in modern frameworks and tools, I create digital solutions that combine elegant design with powerful functionality",
  paragraph:
  ...
  data: [
    {
      ...
      technologies:
        "📒 VB.Net | MS SQL | MY SQL | MS DBMS | SAP Crystal Report ",
      skills: [
    ...
    },
    {
      ...
      technologies:
        "📒 Mongodb | Express.JS | React.JS | Node.JS | Next.js | Css3 | TailwindCss | Npm ",
      skills: [
